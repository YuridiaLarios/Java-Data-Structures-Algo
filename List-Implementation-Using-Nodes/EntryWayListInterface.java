/**
 * This interface represents a list where the user can only access the beginning or
 *  ending elements of a list, not any elements from the middle of the list. 
 *  
 * 
...
public interface EntryWayListInterface<T>
{
   ...
   * @return The object that has been deleted from the top of the list, or null if no object was deleted.
   */
  public T deleteHead();
    ...
    * The list's size is decreased by 1.
    * @return The object that has been deleted from the end of the list, or null if no object was deleted.
    */
  public T deleteTail();
   ...
   *  Positions start at number 1.
   * @param anEntry The object to look for within this list.
   * @return the position of the entry that was found or -1 if not found;
   */
